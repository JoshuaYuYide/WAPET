...
#         self.left.addRow("name", self.name)
#         self.left.addRow("survival rate", self.survival_rate)
#         self.left.addRow("fecundity", self.fecundity)
#         self.left.addRow("initial population", self.initial_population)
#         self.left.addRow("growth rate", self.growth_rate)
#         self.left.addRow("carrying capacity", self.carrying_capacity)
#         self.left.addRow("natural life span", self.natural_life_span)
#
#         self.right = QVBoxLayout()
#         self.right.addLayout(self.left)
